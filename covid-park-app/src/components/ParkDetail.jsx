        ...
        return (
            <>
                <div className="flex justify-between">
                    ...
                    <a className="text-xs underline" href={park && park.link}>{park && park.name}'s nycgovparks.org page</a>
                </div>
                ...
                <div >
                    <img className="w-full h-32 overflow-hidden object-cover" src={park && park.picture_url} />
                </div>
